...
beforeEach(function() {
    dateNowStub = sinon.fake.returns(1111111111);
    sinon.replace(Date, 'now', dateNowStub);
});
...
describe('Module-level features:', function() {
    ...
    describe('when log level isLevel.DEBUG', function() {
        it('should have a priority order lower than Level.INFO', function() {
            expect(Level.DEBUG.priority).to.be.lessThan(Level.INFO.priority);
        });
        it('should have outputString value of DEBUG', function() {
            expect(Level.DEBUG.outputString).to.equal('DEBUG');
        });
    });
    describe('when log level isLevel.INFO', function() {
        it('should have a priority order lower than Level.WARN', function() {
            expect(Level.INFO.priority).to.be.lessThan(Level.WARN.priority);
        });
        it('should have outputString value of INFO', function() {
            expect(Level.INFO.outputString).to.equal('INFO');
        });
    });
    describe('when log level isLevel.WARN', function() {
        it('should have a priority order lower than Level.ERROR', function() {
            expect(Level.WARN.priority).to.be.lessThan(Level.ERROR.priority);
        });
        it('should have outputString value of WARN', function() {
            expect(Level.WARN.outputString).to.equal('WARN');
        });
    });
    describe('when log level isLevel.ERROR', function() {
        it('should have a priority order lower than Level.FATAL', function() {
            expect(Level.ERROR.priority).to.be.lessThan(Level.FATAL.priority);
        });
        it('should have outputString value of ERROR', function() {
            expect(Level.ERROR.outputString).to.equal('ERROR');
        });
    });
    describe('when log level isLevel.FATAL', function() {
        it('should have a priority order lower than Level.OFF', function() {
            expect(Level.FATAL.priority).to.be.lessThan(Level.OFF.priority);
        });
        it('should have outputString value of OFF', function() {
